...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    service_controller.async_receive(
      [&](bacnet::service::i_am s, boost::system::error_code ec, bacnet::common::protocol::meta_information mi){
        std::cout << "received i_am" << std::endl;
        // no action needed
      },
      [&](bacnet::service::who_is s, boost::system::error_code ec, bacnet::common::protocol::meta_information mi){
        std::cout << "received who_is" << std::endl;
        //no response needed, done automatically in the service-layer
      },
      [&](bacnet::service::reinitialize_device s, boost::system::error_code ec, bacnet::common::protocol::meta_information mi){
