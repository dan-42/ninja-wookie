...
private:
  ...
  void setup() {
    ...
    tag_validation_rule =  omit[tag_rule]
                        >> eps( boost::phoenix::bind(&real_grammar::is_as_expected, this) == true );
    tag_rule            = tag_grammar_[_val = boost::phoenix::bind(&real_grammar::extract_tag, this, _1)] ;
